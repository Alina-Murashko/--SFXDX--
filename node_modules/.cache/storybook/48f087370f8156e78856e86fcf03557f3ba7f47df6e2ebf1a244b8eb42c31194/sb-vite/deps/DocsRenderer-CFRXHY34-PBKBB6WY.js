...
import {
  ...
  yI,
  zr
} from "./chunk-3AYFPIMX.js";
import {
  require_core_events
} from "./chunk-3T3HEUF2.js";
import "./chunk-A73KFYK3.js";
import "./chunk-LMRT4C5A.js";
import "./chunk-NBQDA5MJ.js";
import {
  gt,
  yn
...
// node_modules/.pnpm/@storybook+addon-docs@8.4.7_@types+react@18.3.18_storybook@8.4.7/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-5NEULZLW.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-F6OSRLHC-C67X7ALU.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-NUUKLYWV.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-PBKBB6WY.js.map
